...
class MCPServer:
        ...
        for attempt in range(max_retries):
            try:
                ...
                server_params = StdioServerParameters(
                    command="python", args=[self.server_path], env=None
                )
    ...
    async def list_tools(self) -> List[Tool]:
        ...
        return [Tool(tool.name, tool.description, tool.inputSchema) for tool in response.tools]
