...
class MilvusMCPServer(FastMCP):
    ...
    def __init__(self):
        ...
        for config in tool_configs:
            self.add_tool(fn=config["fn"], name=config["name"], description=config["description"])
    ...
    async def store_faq(
        self, question: str, answer: str, metadata: Dict[str, Any] = None
    ) -> Dict[str, Any]:
        ...
        try:
            content = FAQContent(question=question, answer=answer, metadata=metadata or {})
